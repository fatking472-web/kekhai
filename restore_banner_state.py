...
<style>
    ...
    body, html {
        margin: 0 !important;
        padding: 0 !important;
        background-color: #1a2533 !important; /* dark background to blend with globe banner */
    }
    ...
    /* Show and style the globe banner */
    ...
    .portal-home .main, .portal-content {
        margin: 0 !important;
        padding: 0 !important; /* Reset padding to remove any default top spacing */
    ...
    /* Replace the old banner image with the new globe banner */
...
print('Restored previous banner state successfully!')
